...
from ..utils.tf_machinery import NeuralNetwork, DataSet
from ..utils.greenlet_learner import GreenletLearner
from ..utils import common


class PolicyGradient(GreenletLearner):
    """Learn using the Policy Gradient algoritm."""
    ...
    def __init__(self, args):
        ...
        self.pg_loss = tf.reduce_mean(self.ce_loss * self.rewards)
    ...
    def iteration(self, results):
        ...
        self.s.run(self.train_op, feed_dict)
        self.ed.next()
...
def main(argv):
    parser = common.standard_parser("/tmp/Pong/PolicyGradient/", ni=10000,
